    ...
    <div className="p-7">
      <div className="mb-2 font-Urbanist">
        <div className="flex justify-between items-center">
          ...
          <button className="flex items-center p-2 border border-teal-600 shadow-lg transition-all duration-300 hover:bg-teal-700 hover:text-white" onClick={handleWriteReview}>
