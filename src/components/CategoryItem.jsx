...
export default function CategoryItem({ item }) {
  return (
    <div className='w-[180px] md:w-[240px] font-Urbanist relative overflow-hidden flex justify-center items-center shadow-md transition duration-300 ease-in-out hover:shadow-lg'>
      ...
      <div className='absolute inset-0 flex justify-center items-center flex-col gap-5 w-full h-full transition duration-300 ease-in-out hover:bg-opacity-20 hover:bg-black hover:backdrop-blur-sm'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <Link
            ...
            className='px-4 py-2 mb-5 bg-gray-200 border-none shadow-sm rounded-md transition duration-300 ease-in-out'
          >
            Browse
          </Link>
        </div>
