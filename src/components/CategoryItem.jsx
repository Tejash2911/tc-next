...
export default function CategoryItem({ item }) {
  return (
    <div className='relative flex w-[150px] items-center justify-center overflow-hidden shadow-md transition duration-300 ease-in-out hover:shadow-lg md:w-[180px] xl:w-[220px]'>
