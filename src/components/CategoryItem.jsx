...
export default function CategoryItem({ item }) {
  return (
    <div className='w-[150px] md:w-[200px] lg:w-[220px] font-Urbanist relative overflow-hidden flex justify-center items-center shadow-md transition duration-300 ease-in-out hover:shadow-lg'>
      ...
      <div className='absolute inset-0 flex justify-center items-center flex-col gap-5 w-full h-full transition duration-300 ease-in-out hover:bg-opacity-20 hover:bg-black hover:backdrop-blur-sm'>
        <div className='flex flex-col items-center justify-center'>
          ...
          <Link
            ...
            className='px-3 py-1 mb-5 bg-gray-200 border-none shadow-sm rounded-md transition duration-300 ease-in-out'
          >
            Browse
          </Link>
        </div>
